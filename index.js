    ...
    async function main() {
        ...
        const sockOptions = {
            ...
            getMessage: async (key) => {
                ...
                return {
                    conversation: 'An Error Occurred damn, Repeat Command!'
                };
            }
            ///////
        };
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '254111807277';
            const dj2 = '254748840328';
            const dj3 = "254731354120";
            const luffy = '254728796537';
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    await fs.unlink("st1.webp"); } 
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} avoid sending link asshole.`;
      ...
      await zk.sendMessage(origineMessage, { delete: key });
        ...
        console.log('.... ' + er);
            ...
            if (!superUser && origineMessage === auteurMessage&& conf.PM_PERMIT === "yes" ) {
                repondre("Dear asshole you do not have access to commands here") ; return }
            ///////////////////////////////
              ...
              /**********************banuser */
                ...
                if(!superUser) {
                    let req = await isUserBanned(auteurMessage);
                        ...
                        if (req) {repondre("Dear asshole you can no longer use my bot"); return}
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://i.imgur.com/Qz0rzqi.jpeg';
    }
